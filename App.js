...
import KatibuRecordsProvide from "./screens/CfKatibuStack";
import CfFormsRecordProvide from "./screens/CfStackComponent";
              ...
              {userToken.role == "CF" && (
                <Drawer.Group>
                  ...
                  <Drawer.Screen
                    ...
                    component={KatibuRecordsProvide}
                    initialParams={{
                      role: userToken?.role,
                      user: userToken?.user,
                    }}
